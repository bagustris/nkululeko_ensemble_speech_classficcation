...
run_threshold() {
    ...
    python3 -m nkululeko.ensemble cocosda_2024/exp_iemocap_hubert_svm.ini cocosda_2024/exp_iemocap_wavlm_svm.ini --method uncertainty_threshold --threshold $threshold | grep "UAR" | awk '{print $NF}'
}
